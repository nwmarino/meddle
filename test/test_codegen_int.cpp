...
TEST_F(IntegratedCodegenTest, Return_Zero) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_1);
...
TEST_F(IntegratedCodegenTest, Return_Reference) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_2);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, If_Then) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_3);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, If_Then_Else) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_4);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, If_Then_ElseIf_Else) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_5);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Until_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_6);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Until_Continue) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_7);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Until_Break) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_8);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Until_If_Continue_Break) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_9);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, String_Declaration_Copy) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_10);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Truncate_SExt_Integer) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_12);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Truncate_FExt_Float) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_14);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Float_To_SInt) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_15);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Float_To_UInt) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_16);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, SInt_To_Float) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_17);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, UInt_To_Float) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_18);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Match_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_20);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Bool_Declaration_Parentheses) {
    File file = File("test.mdl", "/", "/test.mdl", INT_CGN_22);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Sizeof_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", SIZEOF_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Global_Var_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", GLOBAL_VAR_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Small_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_ASSIGN_SMALL);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Big_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_ASSIGN_BIG);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Int_Add_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_INT_ADD_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_FP_Add_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_FP_ADD_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Int_Sub_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_INT_SUB_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_FP_Sub_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_FP_SUB_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_SInt_Mul_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_SINT_MUL_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_UInt_Mul_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_UINT_MUL_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_FP_Mul_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_FP_MUL_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_SInt_Div_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_SINT_DIV_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_UInt_Div_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_UINT_DIV_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_FP_Div_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_FP_DIV_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_SInt_Mod_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_SINT_MOD_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_UInt_Mod_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_UINT_MOD_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_And_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_AND_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Or_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_OR_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Xor_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_XOR_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Shl_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_SHL_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_SInt_Shr_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_SINT_SHR_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_UInt_Shr_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_UINT_SHR_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Int_Equals) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_INT_EQUALS);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Int_Not_Equals) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_INT_NOT_EQUALS);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_SInt_Less) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_SINT_LESS);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_UInt_Less) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_UINT_LESS);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_FP_Less) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_FP_LESS);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Ptr_Less) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_PTR_LESS);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_SInt_Less_Equals) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_SINT_LESS_EQUALS);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_UInt_Less_Equals) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_UINT_LESS_EQUALS);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_FP_Less_Equals) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_FP_LESS_EQUALS);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Ptr_Less_Equals) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_PTR_LESS_EQUALS);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_SInt_Greater) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_SINT_GREATER);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_UInt_Greater) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_UINT_GREATER);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_FP_Greater) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_FP_GREATER);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Ptr_Greater) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_PTR_GREATER);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_SInt_Greater_Equals) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_SINT_GREATER_EQUALS);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_UInt_Greater_Equals) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_UINT_GREATER_EQUALS);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_FP_Greater_Equals) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_FP_GREATER_EQUALS);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Ptr_Greater_Equals) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_PTR_GREATER_EQUALS);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_And) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_AND);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Or) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_OR);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Xor) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_XOR);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Shl) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_SHL);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_SInt_Shr) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_SINT_SHR);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_UInt_Shr) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_UINT_SHR);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Int_Add) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_INT_ADD);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_FP_Add) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_FP_ADD);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Int_Sub) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_INT_SUB);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_FP_Sub) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_FP_SUB);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_SInt_Mul) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_SINT_MUL);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_UInt_Mul) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_UINT_MUL);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_FP_Mul) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_FP_MUL);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_SInt_Div) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_SINT_DIV);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_UInt_Div) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_UINT_DIV);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_FP_Div) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_FP_DIV);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_SInt_Mod) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_SINT_MOD);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_UInt_Mod) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_UINT_MOD);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Logical_And_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_LOGIC_AND);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Binary_Logical_Or_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_LOGIC_OR);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Unary_Int_Increment) {
    File file = File("test.mdl", "/", "/test.mdl", UNARY_INT_INCREMENT);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Unary_FP_Increment) {
    File file = File("test.mdl", "/", "/test.mdl", UNARY_FP_INCREMENT);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Unary_Int_Decrement) {
    File file = File("test.mdl", "/", "/test.mdl", UNARY_INT_DECREMENT);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Unary_FP_Decrement) {
    File file = File("test.mdl", "/", "/test.mdl", UNARY_FP_DECREMENT);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Unary_Bitwise_Not) {
    File file = File("test.mdl", "/", "/test.mdl", UNARY_BITWISE_NOT);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Unary_Logic_Not) {
    File file = File("test.mdl", "/", "/test.mdl", UNARY_LOGIC_NOT);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Unary_Int_Negative) {
    File file = File("test.mdl", "/", "/test.mdl", UNARY_INT_NEG);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Unary_FP_Negative) {
    File file = File("test.mdl", "/", "/test.mdl", UNARY_FP_NER);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Unary_Deref_LValue) {
    File file = File("test.mdl", "/", "/test.mdl", UNARY_DEREFERENCE_LVALUE);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Unary_Deref_RValue) {
    File file = File("test.mdl", "/", "/test.mdl", UNARY_DEREFERENCE_RVALUE);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Unary_Address_Of) {
    File file = File("test.mdl", "/", "/test.mdl", UNARY_ADDRESS_OF);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Unary_Ptr_Increment) {
    File file = File("test.mdl", "/", "/test.mdl", UNARY_PTR_INCREMENT);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Unary_Ptr_Decrement) {
    File file = File("test.mdl", "/", "/test.mdl", UNARY_PTR_DECREMENT);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Pointer_Arith_Add) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_PTR_ARITH_ADD);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Pointer_Arith_Add_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_PTR_ARITH_ADD_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Pointer_Arith_Sub) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_PTR_ARITH_SUB);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Pointer_Arith_Sub_Assign) {
    File file = File("test.mdl", "/", "/test.mdl", BINARY_PTR_ARITH_SUB_ASSIGN);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Array_Init_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", ARRAY_INIT_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Array_Assign_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", ARRAY_INIT_WITH);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Array_Assign_To) {
    File file = File("test.mdl", "/", "/test.mdl", ARRAY_ASSIGN_TO);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Array_Reassign_To) {
    File file = File("test.mdl", "/", "/test.mdl", ARRAY_REASSIGN_TO);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Subscript_Array_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", SUBSCRIPT_ARRAY_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Subscript_Ptr_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", SUBSCRIPT_PTR_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Function_Aggregate_Return_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", FUNCTION_AGGREGATE_RETURN_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Function_Aggregate_Return_Reference) {
    File file = File("test.mdl", "/", "/test.mdl", FUNCTION_AGGREGATE_RETURN_REF);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Function_Aggregate_Arg_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", FUNCTION_AGGREGATE_ARG_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Function_Aggregate_Arg_Many) {
    File file = File("test.mdl", "/", "/test.mdl", FUNCTION_AGGREGATE_ARG_MANY);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Call_Void_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", CALL_VOID_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Call_Typed_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", CALL_TYPED_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Call_Args_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", CALL_ARGS_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Call_Args_RValue_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", CALL_ARGS_RVALUE_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Call_Aggregate_Array_Return_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", CALL_AGGREGATE_ARRAY_RETURN_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Call_Aggregate_Array_Arg_Ref_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", CALL_AGGREGATE_ARRAY_ARG_REF_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Call_Aggregate_Array_Arg_Init_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", CALL_AGGREGATE_ARRAY_ARG_INIT_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Call_Aggregate_Array_Return_And_Aggregate_Array_Arg_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", CALL_AGGREGATE_ARRAY_RETURN_AGGREGATE_ARRAY_ARG_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, AArg_Return_Array_Init) {
    File file = File("test.mdl", "/", "/test.mdl", AGGREGATE_RETURN__RETURN_ARRAY_INIT);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Nested_Array_Init) {
    File file = File("test.mdl", "/", "/test.mdl", NESTED_ARRAY_INIT);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Struct_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", STRUCT_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Struct_Method_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", STRUCT_METHOD_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Struct_Method_Field_Ref) {
    File file = File("test.mdl", "/", "/test.mdl", STRUCT_METHOD_FIELD_REF);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Struct_Access_Val_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", STRUCT_ACCESS_VAL_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Struct_Access_Ptr_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", STRUCT_ACCESS_PTR_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Spec_Struct_Method_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", SPEC_STRUCT_METHOD_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Spec_Struct_Associated_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", SPEC_STRUCT_ASSOCIATED_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Method_Call_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", METHOD_CALL_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Method_Call_Args_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", METHOD_CALL_ARGS_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Struct_Init_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", STRUCT_INIT_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Struct_Init_Partial) {
    File file = File("test.mdl", "/", "/test.mdl", STRUCT_INIT_PARTIAL);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Nested_Struct_Init) {
    File file = File("test.mdl", "/", "/test.mdl", NESTED_STRUCT_INIT);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Array_Nested_Struct_Init) {
    File file = File("test.mdl", "/", "/test.mdl", ARRAY_NESTED_STRUCT_INIT);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Struct_Nested_Array_Init) {
    File file = File("test.mdl", "/", "/test.mdl", STRUCT_NESTED_ARRAY_INIT);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Call_Aggregate_Struct_Return_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", CALL_AGGREGATE_STRUCT_RETURN_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Call_Aggregate_Struct_Arg_Ref_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", CALL_AGGREGATE_STRUCT_ARG_REF_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Call_Aggregate_Struct_Arg_Init_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", CALL_AGGREGATE_STRUCT_ARG_INIT_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Call_Aggregate_Struct_Return_Aggregate_Struct_Arg_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", CALL_AGGREGATE_STRUCT_RETURN_AGGREGATE_STRUCT_ARG_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Aggregate_Return__Return_Struct_Init) {
    File file = File("test.mdl", "/", "/test.mdl", AGGREGATE_RETURN__RETURN_STRUCT_INIT);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Method_Call_Aggregate_Struct_Return_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", METHOD_CALL_AGGREGATE_STRUCT_RETURN_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
...
TEST_F(IntegratedCodegenTest, Method_Call_Aggregate_Struct_Arg_Ref_Basic) {
    File file = File("test.mdl", "/", "/test.mdl", METHOD_CALL_AGGREGATE_STRUCT_ARG_REF_BASIC);
    Lexer lexer = Lexer(file);
    TokenStream stream = lexer.unwrap();
    Parser parser = Parser(file, stream);
    TranslationUnit *unit = parser.get();
